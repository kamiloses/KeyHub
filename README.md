...
<h3>Initially, you will be redirected to the Home Page, where you can see games available at the biggest discounts.</h3>
<img width="1838" height="1012" alt="image" src="https://github.com/user-attachments/assets/99355ca9-1abb-4cc1-ac9f-59cfbd094e97" />
<img width="1838" height="1012" alt="image" src="https://github.com/user-attachments/assets/99355ca9-1abb-4cc1-ac9f-59cfbd094e97" />

You can either create an account or log in, depending on your situation.
Validation has been implemented on both the client and server sides.
...
Pagination has been added to improve the efficiency of fetching data from the database.
...
<h3>As an admin, you have access to a special button that allows you to publish a new game for sale.</h3>
